<template>
  <div>
    ...
    <div class="head">
      <el-row :gutter="20">
        <el-col :span="6"><el-input v-model="userInfo.name" placeholder="请输入姓名" /></el-col>
        <el-col :span="6"><el-input v-model="userInfo.gender" placeholder="请输入性别" /></el-col>
        <el-col :span="6"><el-input v-model="userInfo.phoneNum" placeholder="请输入电话号码" /></el-col>
...
<style>
.add-btn{ margin-top: 20px; width: 100%;}
